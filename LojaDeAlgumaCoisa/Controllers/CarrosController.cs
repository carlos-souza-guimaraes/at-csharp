...
namespace LojaDeAlgumaCoisa.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Ano,Linha,Preco,Vendido,Placa,Registro")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Ano,Linha,Preco,Vendido,Placa,Registro")] Carro carro)
        {
            if (id != carro.Id)
            {
                return NotFound();
